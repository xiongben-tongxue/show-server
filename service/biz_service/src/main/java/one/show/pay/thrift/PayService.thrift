...
service PayServiceProxy{
	...
	list<TransactionToView.TransactionToView> findTransactionToUidList(1:i64 uid,2:map<string,string> params,3:i32 satrt,4:i32 pageCount);
	
	i32 findTransactionToUidCount(1:i64 uid,2:map<string,string> params);
	...
	list<TransactionFromView.TransactionFromView> findTransactionFromViewListByParams(1:i64 uid,2:map<string,string> params,3:i32 start,4:i32 pageCount);
	
	i32 findTransactionFromViewCountByParams(1:i64 uid,2:map<string,string> params);
	...
	list<GiftRankView.GiftRankView> findGiftRanksByUid(1:i64 uid,2:i32 start,3:i32 count);
